...
<script>
	...
	function clearValidity(){
		document.getElementById('optradio').setCustomValidity('');
	}
</script>
...
<title>SuccessFactors Login</title>
...
<link href="css/avance/BizXLoginTheme.css" type="text/css"
...
<body class="login_branded globalThemed" role="application"
	...
	<link href="css/avance/BizXLogin_877b22373b3af8dfe7040ef59e3baeb1.css"
		type="text/css" rel="stylesheet">
	<!-- 	<script src="js/avance/loginBizX_9b285856323df3ad72442f77f4d29602.js" -->
	<!-- 		type="text/javascript"></script> -->
	...
	<div id="bodyContent" data-sap-ui-area="bodyContent"
		...
		<div id="__jsview0" data-sap-ui="__jsview0"
						...
						<div id="__layout9" data-sap-ui="__layout9"
							...
							<div class="sapUiVltCell sapuiVltCell">
								<div id="__layout8" data-sap-ui="__layout8"
									...
									<div class="sapUiVltCell sapuiVltCell">
										<img id="__image1" data-sap-ui="__image1" src="images/a.gif"
											class="globalLoginLogoImg sapMImg sapMImgFocusable"
											alt="Companhia Brasileira de Distribuição Logótipo"
											aria-label="Companhia Brasileira de Distribuição Logótipo"
											title="Companhia Brasileira de Distribuição Logótipo">
									</div>
									<div id="divErro" class="sapUiVltCell sapuiVltCell">
										<font size="2" color="white"><p><c:out value="${msgErro}" /></p></font>
									</div>
								</div>
							</div>
							...
							<div class="sapUiVltCell sapuiVltCell">
								<form id="loginForm" data-sap-ui="loginForm"
											...
											<div id="__layout5" data-sap-ui="__layout5"
												...
												<div class="sapUiHLayoutChildWrapper">
													<span id="__icon1" data-sap-ui="__icon1"
														...
														class="manImg" src="images/person.png">
													</span>
												</div>
												<div class="sapUiHLayoutChildWrapper">
														...
														<div id="__input1-content"
															...
															<div class="sapMInputBaseDynamicContent">
																<input id="__input1-inner" name="j_username"
																	...
																	class="sapMInputBaseInner" accesskey="1">
															</div>
														</div>
														<span id="__input1-labelledby" aria-hidden="true"
															class="sapUiInvisibleText">Matr�cula</span>
													</div>
												</div>
											</div>
										</div>
											...
											<div id="__layout6" data-sap-ui="__layout6"
												...
												<div class="sapUiHLayoutChildWrapper">
													<span id="__icon2" data-sap-ui="__icon2"
														...
														class="inputIcon sapUiIcon sapUiIconMirrorInRTL"
														style="font-family: &amp; amp;"> <img
														class="manImg" src="images/password.png">
													</span>
												</div>
												<div class="sapUiHLayoutChildWrapper">
									...
									<div style="padding-top: 20px;" align=center>
										<label class="radio-inline"> <input type="radio" id="optradio" name="optradio" value="MV" required oninvalid="this.setCustomValidity('Favor selecionar a sua BU')" onclick="clearValidity()">Corp/MV/Malls</label> 
										<label class="radio-inline"> <input type="radio" name="optradio" value="Assai" onclick="clearValidity()">Assai</label> 
										<label class="radio-inline"> <input type="radio" name="optradio" value="CompreBem" onclick="clearValidity()">Comprebem</label>
			...
			<div class="globalLoginFooter bizXFooter"
				...
				<span class="copyrightText" style="color: black">Copyright © <a class="link"
					href="http://www.successfactors.com/"
					onclick="window.open(this.href); return false;" style="color: black">2019
						SuccessFactors, Inc.</a> Todos os direitos reservados. Estes servicos
					on-line saoo confidenciais e de propriedade da SuccessFactors e
					para uso apenas de clientes autorizados da SuccessFactors.
				</span><a class="versionInfoLink link" href="javascript:void(0);"
					id="version_info_link"
					onclick="sap.sf.login.bizx.BizXLogin.showVersionInfo(this); return false;" style="color: black">Exibir
					informacoes de versao.</a>
			</div>
		</div>
	</div>
